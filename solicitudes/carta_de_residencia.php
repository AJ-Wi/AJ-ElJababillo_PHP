...
$filename = '../validacion/'.$BCedula.'R.png';
QRcode::png('https://consejoeljabillo.com.ve/validacion?CI='.$BCedula.'R', $filename, 'H', 2, 2);
...
date_default_timezone_set ('America/La_Paz');
	...
	$html1 .= '<b>'.strtoupper(utf8_decode($Nombre)).'</b>, portador  de la cédula de identidad N° <b>'.number_format($BCedula, 0, ',', '.').'</b>, y de nacionalidad <b>'.$Nacionalidad.'</b>';
	$html2 = '           Quien <b>BAJO FE DE JURAMENTO DECLARA</b> que habita de forma permanente en la siguiente dirección: <b>'.strtoupper($Direccion).'</b>, por lo que pertenece al ámbito geográfico del Consejo comunal.';
